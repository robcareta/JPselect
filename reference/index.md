...
- [`JPselect-package`](https://robcareta.github.io/JPselect/reference/JPselect-package.md)
  [`JPselect`](https://robcareta.github.io/JPselect/reference/JPselect-package.md)
...
- [`plot(`*`<jpfit>`*`)`](https://robcareta.github.io/JPselect/reference/plot.jpfit.md)
  : Plot the risk-function coefficients of a fitted \`jpfit\` object
- [`coef(`*`<jpfit>`*`)`](https://robcareta.github.io/JPselect/reference/coef.jpfit.md)
...
- [`estimate_selection()`](https://robcareta.github.io/JPselect/reference/estimate_selection.md)
  : Estimate the crop-choice selection equation and compute the Inverse
  Mills Ratio
- [`estimate_mean_function()`](https://robcareta.github.io/JPselect/reference/estimate_mean_function.md)
  : Estimate the Just-Pope mean production function with selectivity
  correction
- [`estimate_risk_function()`](https://robcareta.github.io/JPselect/reference/estimate_risk_function.md)
...
- [`jp_export()`](https://robcareta.github.io/JPselect/reference/jp_export.md)
...
- [`prepare_caf_data()`](https://robcareta.github.io/JPselect/reference/prepare_caf_data.md)
  : Prepare Chilean Agricultural Census (CAF 2021) data for \[jp_fit()\]
- [`caf2021_docs()`](https://robcareta.github.io/JPselect/reference/caf2021_docs.md)
  : Open the CAF 2021 documentation bundled with the package
- [`caf2021_g2_groups()`](https://robcareta.github.io/JPselect/reference/caf2021_g2_groups.md)
